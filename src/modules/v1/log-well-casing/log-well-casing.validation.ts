...
export const createLogWellCasingSchema = Joi.object({
...
export const updateLogWellCasingSchema = Joi.object({
  depthFrom: optionalTrimmed(DEPTH_MAX_LENGTH),
  depthTo: optionalTrimmed(DEPTH_MAX_LENGTH),
...
export const listLogWellCasingsQuerySchema = Joi.object({
