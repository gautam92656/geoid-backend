...
export const createLogDrillingCasingSchema = Joi.object({
...
export const updateLogDrillingCasingSchema = Joi.object({
...
export const listLogDrillingCasingsQuerySchema = Joi.object({
