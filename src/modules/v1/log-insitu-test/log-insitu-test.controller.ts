...
import * as testService from "./log-insitu-test.service"
import {
  createLogInsituTestSchema,
  listLogInsituTestsQuerySchema,
  projectLogParamsSchema,
  updateLogInsituTestSchema,
} from "./log-insitu-test.validation"
...
export async function list(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const { error, value } = listLogInsituTestsQuerySchema.validate(req.query, {
    abortEarly: false,
    convert: true,
  })
  if (error) {
...
export async function getOne(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const data = await testService.getOne(userId, ids.projectId, ids.logId, id)
  successResponse(res, data, undefined, HTTP_STATUS.OK)
}
...
export async function create(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const { error, value } = createLogInsituTestSchema.validate(req.body, {
    abortEarly: false,
    stripUnknown: true,
    convert: false,
  })
  ...
  const data = await testService.create(userId, ids.projectId, ids.logId, value)
  successResponse(res, data, API_MESSAGES.LOG_INSITU_TEST_ADDED, HTTP_STATUS.CREATED)
}
...
export async function update(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const { error, value } = updateLogInsituTestSchema.validate(req.body, {
    abortEarly: false,
    stripUnknown: true,
    convert: false,
  })
  ...
  const data = await testService.update(userId, ids.projectId, ids.logId, id, value)
  successResponse(res, data, API_MESSAGES.LOG_INSITU_TEST_UPDATED, HTTP_STATUS.OK)
}
...
export async function remove(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const data = await testService.remove(userId, ids.projectId, ids.logId, id)
  successResponse(res, data, API_MESSAGES.LOG_INSITU_TEST_DELETED, HTTP_STATUS.OK)
}
...
export async function restore(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const data = await testService.restoreTest(userId, ids.projectId, ids.logId, id)
  successResponse(res, data, API_MESSAGES.LOG_INSITU_TEST_RESTORED, HTTP_STATUS.OK)
}
...
export async function copy(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const data = await testService.copy(userId, ids.projectId, ids.logId, id)
  successResponse(res, data, API_MESSAGES.LOG_INSITU_TEST_ADDED, HTTP_STATUS.CREATED)
}
