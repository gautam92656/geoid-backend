...
import * as sampleService from "./log-sample.service"
import {
  createLogSampleSchema,
  listLogSamplesQuerySchema,
  projectLogParamsSchema,
  updateLogSampleSchema,
} from "./log-sample.validation"
...
export async function list(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const { error, value } = listLogSamplesQuerySchema.validate(req.query, {
    abortEarly: false,
    convert: true,
  })
  if (error) {
...
export async function getOne(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const data = await sampleService.getOne(userId, ids.projectId, ids.logId, id)
  successResponse(res, data, undefined, HTTP_STATUS.OK)
}
...
export async function create(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const { error, value } = createLogSampleSchema.validate(req.body, {
    abortEarly: false,
    stripUnknown: true,
    convert: false,
  })
  ...
  const data = await sampleService.create(userId, ids.projectId, ids.logId, value)
  successResponse(res, data, API_MESSAGES.LOG_SAMPLE_ADDED, HTTP_STATUS.CREATED)
}
...
export async function update(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const { error, value } = updateLogSampleSchema.validate(req.body, {
    abortEarly: false,
    stripUnknown: true,
    convert: false,
  })
  ...
  const data = await sampleService.update(userId, ids.projectId, ids.logId, id, value)
  successResponse(res, data, API_MESSAGES.LOG_SAMPLE_UPDATED, HTTP_STATUS.OK)
}
...
export async function remove(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const data = await sampleService.remove(userId, ids.projectId, ids.logId, id)
  successResponse(res, data, API_MESSAGES.LOG_SAMPLE_DELETED, HTTP_STATUS.OK)
}
...
export async function restore(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const data = await sampleService.restoreSample(userId, ids.projectId, ids.logId, id)
  successResponse(res, data, API_MESSAGES.LOG_SAMPLE_RESTORED, HTTP_STATUS.OK)
}
...
export async function copy(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  const data = await sampleService.copy(userId, ids.projectId, ids.logId, id)
  successResponse(res, data, API_MESSAGES.LOG_SAMPLE_ADDED, HTTP_STATUS.CREATED)
}
